...
#     backend = "cmdstanr",
#     stan_model_args = list(stanc_options = list("O1") ),
#     file = "models/timegen_gam_meg_t2_k30_full_gaussian.rds"
#     )
```
